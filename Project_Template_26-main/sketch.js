...
for(var i = 0; i< playerArrows.length; i++){
  ...
  var archerCollision = Matter.SAT.collides( playerArrows[i].body,computerBase.body)
  var computerCollision = Matter.SAT.collides( playerArrows[i].body,computerBase.body)
...
function handleComputerArrowCollision() {
  ...
  for(var i = 0; i< playerArrows.length; i++){
    ...
    if(baseCollision2|| archerCollision2||computerCollision2){
